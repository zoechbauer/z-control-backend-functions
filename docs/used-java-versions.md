...
Java 21 is used for the frontend repositories in the z-control app suite and remains the global/default Java version on this machine.

## Java 17

Java 17 is used for the frontend repository of **z-control QR Code** because it uses Angular 18.
